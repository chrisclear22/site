$(document).ready(function(){
	...
	$('.prev').click(function(e){
		...
		$('.nav1 li').attr('id', ''); //make all the navtabs inactive
		$(".nav1 li:eq("+(whichOne-1)+")").attr('id', 'activetab'); //make previous tab active

		$('fieldset').attr('class', 'hidden1'); //hide all the fieldsets
	...
	$('.next').click(function(e){
		...
		$('.nav1 li').attr('id', ''); //make all the navtabs inactive
		$(".nav1 li:eq("+(whichOne+1)+")").attr('id', 'activetab'); //make next tab active
