...
<script src="js/bootstrap.min.js"></script>
 <script>
  ...
  <script> 
        ...
        $.ajax({ 
        url : "http://api.wunderground.com/api/df523ab79a6d3d46/geolookup/conditions/forecast/q/French_Polynesia/Bora_Bora.json", 
        dataType : "jsonp", 
        ...
        $('#weather_info').append("Weather for " + location);
...
<!-- googlMaps scripts -->
  <script>
      ...
      {
        var mapProp = {
          center: new google.maps.LatLng(-16.500413,-151.741490),
          zoom:10,
